...
export const translations = {
  en: {
    ...
    modalEndpoint: "Modal Endpoint",
    modalEndpointHelp: "Deploy your Modal service and paste the endpoint URL here.",
    modalEndpointLink: "Modal Docs",
    tokenTotal: "Total",
    tokenActive: "Active",
    ...
    error_modal_endpoint_required: "Modal endpoint is required. Please configure it in Settings.",
    error_modal_rate_limit: "Modal rate limit exceeded. Please try again later.",
  ...
  zh: {
    ...
    msTokenLink: "访问令牌",
    msTokenHelpEnd: "从控制台。",
    modalEndpoint: "Modal 端点",
    modalEndpointHelp: "部署您的 Modal 服务后，将端点 URL 粘贴到此处。",
    modalEndpointLink: "Modal 文档",
    tokenTotal: "总数",
    tokenActive: "可用",
    tokenExhausted: "耗尽",
    cancel: "取消",
    ...
    error_modal_endpoint_required: "需要配置 Modal 端点。请在设置中进行配置。",
    error_modal_rate_limit: "Modal 请求频率超限，请稍后重试。",
